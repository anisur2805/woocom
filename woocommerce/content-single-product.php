<?php
	...
	$product_layout = isset( $_GET['single_product_gallery_layout'] ) ? $_GET['single_product_gallery_layout'] : '';
	$product_layout = isset( $_GET['single_product_gallery_layout'] ) ? $_GET['single_product_gallery_layout'] : '';
	if ( 'vertical' == $product_layout ) {
		$product_layout = "vertical_product";
	} else if('gallery' == $product_layout ) {
		$product_layout = "gallery";
	} else {
		$product_layout = "";
	}
	...
	<div class="single_product_wrapper">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 conditional_layout <?php echo esc_html( $product_layout ); ?>">
					<?php
						/**
					...
					if ( !empty( $attachment_ids ) ) {?>
						...
						<script>
							jQuery(document).ready(function($){
								...
								if ($(".conditional_layout").hasClass("vertical_product")){
									$('.vertical_product .product-gallery-image').slick({
										slidesToShow: 3,
										slidesToScroll: 1,
									...
									console.log('Vertical Product with')
								} else {
									...
									console.log('Vertical Product without')
								}
							});
						</script>
